    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-end">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-4 gap-8 md:gap-0">
          ...
          {/* Right - Menu */}
          <div className="grid grid-cols-2 gap-x-12 gap-y-4 md:flex md:gap-8 text-sm font-medium uppercase tracking-widest text-white/70 w-full md:w-auto text-center md:text-right items-center justify-center">
            <Link href={pathname === '/' ? '#projects' : '/#projects'} className="hover:text-white transition-colors">
              Projects
            </Link>
            <Link href={pathname === '/' ? '#about' : '/#about'} className="hover:text-white transition-colors">
              About
            </Link>
            {pathname === '/contact' ? (
              <button
            ...
            <a href="mailto:alferroputra1313@gmail.com" className="hover:text-white transition-colors">Email</a>
            <a href="https://www.linkedin.com/in/al-ferro-putra-yusanda-341ab2270/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">LinkedIn</a>
          </div>
        </div>
